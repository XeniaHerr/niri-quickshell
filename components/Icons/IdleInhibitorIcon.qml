...
import qs.config
Item {
//    property alias colors: Config.data.appearance.colors
    id: root
    property string color: defaultColor
    property string defaultColor: "#ff000000"
    property string highlightcolor: Config.data.appearance.colors.blue
	...
	ShapePath {
	    fillColor: root.opened ? root.color : "transparent"
